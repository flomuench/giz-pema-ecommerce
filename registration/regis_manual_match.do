...
local observations 532 533 530 536 528 483 473 436 383 365 363 350 478 313 289 314 289 273 272 271 203 111 82 83 84 42 29 24 12 11 7 3 2 1 505 540 541 542 543 544 545 546 547 548 549 550 551 552 553 555 557 558 559 560 561 562 563 564 565 566 567 568 569 571 573 574 583 586 588 589 594 595 599 606 605 604 610 612 619 620 618 616 623 627 635 639 642 651 656 653 664 666 668 665 672 679 683 680 730 725 758 798 813 802 
foreach obs of local observations {
	replace correct_match = 1 if id_candidates == `obs'
}

tab correct_match /* result should be N = 95 */
