...
***********************************************************************+
cd "$regis_final"
export excel id_plateforme firmname rg_emailrep rg_emailpdg rg_email2 rg_telrep rg_telpdg rg_telephone2 using "eligible_finale" if finally_eligible == 1, replace firstrow(var)
