...
>>>>>>> Stashed changes
/* --------------------------------------------------------------------
	PART 8: Fix mutliple choice questions
----------------------------------------------------------------------*/
{
* variable dig_con2
...
gen dig_presence3_littlejeina = 0
replace dig_presence3_littlejeina = 1 if strpos(dig_presence3_exemples, "r1")
lab var dig_presence3_littlejeina "Little Jneina"

gen dig_presence3_elfabrica = 0
replace dig_presence3_elfabrica = 1 if strpos(dig_presence3_exemples, "r2")
lab var dig_presence3_elfabrica "elfabrica.tn"

gen dig_presence3_savana = 0
replace dig_presence3_savana = 1 if strpos(dig_presence3_exemples, "r3")
lab var dig_presence3_savana "Savana"

gen dig_presence3_jumia = 0
replace dig_presence3_jumia = 1 if strpos(dig_presence3_exemples, "r4")
lab var dig_presence3_jumia "Jumia"

gen dig_presence3_amazon = 0
replace dig_presence3_amazon = 1 if strpos(dig_presence3_exemples, "r5")
lab var dig_presence3_amazon "Amazon"

gen dig_presence3_alibaba = 0
replace dig_presence3_alibaba = 1 if strpos(dig_presence3_exemples, "r6")
lab var dig_presence3_alibaba "Ali baba"

gen dig_presence3_etsy = 0
replace dig_presence3_etsy = 1 if strpos(dig_presence3_exemples, "r7")
lab var dig_presence3_etsy "Etsy"

gen dig_presence3_autres = 0
replace dig_presence3_autres = 1 if strpos(dig_presence3_exemples, "r8")
lab var dig_presence3_autres "Autres marketplace"

gen dig_presence3_nsp = 0
replace dig_presence3_nsp = 1 if strpos(dig_presence3_exemples, "-999")
lab var dig_presence3_nsp "Ne sais pas"
...
lab var dig_marketing_num19_autre "Autres activités de marketing digital "
...
drop if Id_plateforme==.
=======
gen horaire_pref_avant9 = 0
replace horaire_pref_avant9 = 1 if strpos( horaire_pref, "1")
lab var horaire_pref_avant9 "Avant 9h "

gen horaire_pref_9a12 = 0
replace horaire_pref_9a12 = 1 if strpos( horaire_pref, "2")
lab var horaire_pref_9a12 "9-12h"

gen horaire_pref_3a18 = 0
replace horaire_pref_3a18 = 1 if strpos( horaire_pref, "3")
lab var horaire_pref_3a18 "3-18h"
>>>>>>> Stashed changes

gen horaire_pref_18a22 = 0
replace horaire_pref_18a22 = 1 if strpos( horaire_pref, "4")
lab var horaire_pref_18a22 "18-22"

gen horaire_pref_autre = 0
replace horaire_pref_autre = 1 if strpos( horaire_pref, "5 ")
lab var horaire_pref_autre "Autres horaire"
...
***********************************************************************
* 	PART 9: Removing trail and leading spaces in from string variables  			
***********************************************************************
...
global numvars info_compt1 dig_revenues_ecom comp_benefice2020 comp_ca2020 compexp_2020 tel_sup2 tel_sup1 car_carempl_div1 car_carempl_div2 car_carempl_div3 dig_marketing_respons investcom_futur investcom_2021 expprep_responsable exp_pays_avant21 exp_pays_21    dig_marketing_respons dig_service_responsable investcom_2021 investcom_futur expprep_responsable exp_pays_avant21 exp_pays_21 compexp_2020 comp_ca2020 dig_revenues_ecom comp_benefice2020 car_carempl_div1 car_carempl_div2 car_carempl_div3 car_adop_peer
>>>>>>> Stashed changes
