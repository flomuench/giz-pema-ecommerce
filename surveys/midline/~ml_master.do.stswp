...
*	Note: 205 rows (firms) out of sample of 210. 					  
*	Requires:  	  										  
*	Creates:  
***********************************************************************
...
***********************************************************************
/* --------------------------------------------------------------------
	PART 3.1: Import & raw data (N = 993 due to empty rows)
	Requires: ml_raw
	Creates:  ml_intermediate
----------------------------------------------------------------------*/		
if (1) do "${ml_github}/ml_import.do"
/* --------------------------------------------------------------------
	PART 3.2: Clean raw data & save as intermediate data (N = 205)
----------------------------------------------------------------------*/	
...
/* --------------------------------------------------------------------
--------------------------------------------------------------------
	PART 3.5: Create statistics	for the survey
----------------------------------------------------------------------*/	
