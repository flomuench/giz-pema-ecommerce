***********************************************************************
* 			generate do file, second part midline e-midline				  
***********************************************************************
*																	  
...
*                         											  
*																	  
*	Author:  			Ayoub Chamakh				    
*	ID variable: 		id_platforme  					  
*	Requires:  	  		ml_Webpresence_answers_intermediate.dta									  
*	Creates:  			ml_Webpresence_answers_final.dta
***********************************************************************
...
gen web_phone = regex(web_contact, "t̩l̩phone")
...
gen social_phone = regex(social_contact, "t̩l̩phone")	
...
gen insta_phone = regex(insta_contact, "t̩l̩phone")
...
*/
gen facebook_age = round((td(05sep2022)-facebook_creation)/365.25,.01)
...
gen datediff = social_last - social_beforelast_publication	
...
save "${ml2_final}/ml_Webpresence_answers_final", replace
