***********************************************************************
* 			correct do file, second part midline e-commerce				  
***********************************************************************
*																	  
...
local binaryvars Lentreprisedisposetelledun LeproduitserviceestildÃcri Ladescriptionduproduitservic Lesitecomportetilunesectio ///
LesiteprÃsentetildesnorme LesiteestilproposÃdansune Lecontenuestillisiblepare Existetildesliensversunma T LapagedurÃseausocialcompor ///
LapagedurÃseausocialcontie LapagedurÃseausocialconti EstcequelentreprisepossÃde Lapagedisposetelledelopti AL Leprofildelentreprisecontie Leprofildelentreprisefourni
...
local logonamevars LapagedurÃseausocialindiqu LesiteWebindiquetilclairem
foreach var of local logonamevars {
	...
	capture replace `var' = "0" if strpos(`var', "Ni le nom ni le logo ne sont clairement indiquÃ©s")


}	

	*entreprise selling methods
replace Lentreprisevendellesonprodu = "2" if Lentreprisevendellesonprodu == "Lâ€™entreprise semble vendre Ã  la fois aux consommateurs et aux entreprises."
replace Lentreprisevendellesonprodu = "1" if Lentreprisevendellesonprodu == "L'entreprise vend Ã  d'autres entreprises (B2B)."
replace Lentreprisevendellesonprodu = "0" if Lentreprisevendellesonprodu == "L'entreprise vend Ã  des consommateurs (personnes physiques)."
replace Lentreprisevendellesonprodu = "." if Lentreprisevendellesonprodu == "projets de dÃ©veloppement local et rÃ©gional "
...
replace Lecontenusechargetilcorrec = "1" if Lecontenusechargetilcorrec == "L'un des deux contenus, textuel ou visuel, est long Ã  charger mais l'autre se charge rapidement"
...
local notyesnovariables LesiteWebindiquetilclairem LeproduitserviceestildÃcri Ladescriptionduproduitservic Lesitecomportetilunesectio ///
LesiteprÃsentetildesnorme Lentreprisevendellesonprodu Danslecasducommerceinterent Estcequelesliensexternesfo LesiteestilproposÃdansune ///
ParmilespossibilitÃsdeconta Lecontenuestillisiblepare Lecontenusechargetilcorrec Pouvezvousacheteroucommander Existetildesliensversunma ///
Siouiversquellesplacesdem T Veuillezcollercidessousleli LapagedurÃseausocialindiqu LapagedurÃseausocialcompor LapagedurÃseausocialcontie ///
LapagedurÃseausocialconti Z PourlequeldesrÃseauxsociaux EstcequelentreprisepossÃde Veuillezcollerleliendelapa CombiendeavislapagepossÃde ///
Lapagedisposetelledelopti AL Leprofildelentreprisecontie Leprofildelentreprisefourni Parmilesinformationsdecontac
