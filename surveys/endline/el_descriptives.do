...
tw ///
	...
	*Knowledge questions
tw ///
	(kdensity dig_con1_el if formation == 1, lp(l) lc(maroon) yaxis(2) bw(0.4)) ///
	(histogram dig_con1_el if formation == 1, freq w(.1) recast(scatter) msize(small) mc(maroon)) ///
	(kdensity dig_con1_el if formation == 0, lp(l) lc(navy) yaxis(2) bw(0.4)) ///
	(histogram dig_con1_el if formation == 0, freq w(.1) recast(scatter) msize(small) mc(navy)) ///
	, ///
	title("{bf:Full sample}") ///
...
tw ///
	(kdensity dig_con2_el if formation == 1, lp(l) lc(maroon) yaxis(2) bw(0.4)) ///
	(histogram dig_con2_el if formation == 1, freq w(.1) recast(scatter) msize(small) mc(maroon)) ///
	(kdensity dig_con2_el if formation == 0, lp(l) lc(navy) yaxis(2) bw(0.4)) ///
	(histogram dig_con2_el if formation == 0, freq w(.1) recast(scatter) msize(small) mc(navy)) ///
	, ///
	title("{bf:Full sample}") ///
	subtitle("{it:Absolute points (between -1 & 1)}", size(vsmall)) ///
...
tw ///
	(kdensity dig_con3_el if formation == 1, lp(l) lc(maroon) yaxis(2) bw(0.4)) ///
	(histogram dig_con3_el if formation == 1, freq w(.1) recast(scatter) msize(small) mc(maroon)) ///
	(kdensity dig_con3_el if formation == 0, lp(l) lc(navy) yaxis(2) bw(0.4)) ///
	(histogram dig_con3_el if formation == 0, freq w(.1) recast(scatter) msize(small) mc(navy)) ///
	, ///
	title("{bf:Full sample}") ///
	subtitle("{it:Absolute points (between -1 & 1)}", size(vsmall)) ///
...
tw ///
	(kdensity dig_con4_el if formation == 1, lp(l) lc(maroon) yaxis(2) bw(0.4)) ///
	(histogram dig_con4_el if formation == 1, freq w(.1) recast(scatter) msize(small) mc(maroon)) ///
	(kdensity dig_con4_el if formation == 0, lp(l) lc(navy) yaxis(2) bw(0.4)) ///
	(histogram dig_con4_el if formation == 0, freq w(.1) recast(scatter) msize(small) mc(navy)) ///
	, ///
	title("{bf:Full sample}") ///
	subtitle("{it:Absolute points (between -1 & 1)}", size(vsmall)) ///
	...
	putpdf pagebreak	
tw ///
	(kdensity dig_con5_el if formation == 1, lp(l) lc(maroon) yaxis(2) bw(0.4)) ///
	(histogram dig_con5_el if formation == 1, freq w(.1) recast(scatter) msize(small) mc(maroon)) ///
	(kdensity dig_con5_el if formation == 0, lp(l) lc(navy) yaxis(2) bw(0.4)) ///
	(histogram dig_con5_el if formation == 0, freq w(.1) recast(scatter) msize(small) mc(navy)) ///
	, ///
	title("{bf:Full sample}") ///
	subtitle("{it:Absolute points (between -1 & 1)}", size(vsmall)) ///
