...
frame evolution_ecom: collapse (mean) VALEUR, by(Year)

*sectors
use "${cp_intermediate}/cp_intermediate_ecommerce_transaction", clear
frame put sector VALEUR, into(sector_ecom)
frame sector_ecom: collapse (mean) VALEUR, by(sector)

*sub-sector
use "${cp_intermediate}/cp_intermediate_ecommerce_transaction", clear
frame put subsector VALEUR, into(subsector_ecom)
frame subsector_ecom: collapse (mean) VALEUR, by(subsector)
