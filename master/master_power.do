...
putexcel I2 = "Number of FB followers", border(bottom) hcenter
...
putexcel A13 = "Power", italic left
...
putexcel A17 = "MDE at 80% power", italic
...
local power = r(power)
putexcel B18 = 0.17, hcenter nformat(number_d2)

	* after controlling for strata_final --> add
sampsi 0.76 0.88, n1(107) n2(105) sd1(0.29) sd2(0.29)
local power = r(power)
putexcel B19 = 0.12, hcenter nformat(number_d2)

	* Ancova 1 year before
sampsi 0.76 0.83, n1(107) n2(105) sd1(0.29) sd2(0.29) pre(1) post(1) r1(0.8)
local power = r(power)
putexcel B20 = 0.07, hcenter nformat(number_d2)
...
local power = r(power)
putexcel C18 = 2.46, hcenter nformat(number_d2)

	* after controlling for strata_final --> add
sampsi 10.04 11.3, n1(107) n2(105) sd1(3.28) sd2(3.28)
local power = r(power)
putexcel C19 = 1.26, hcenter nformat(number_d2)

	* Ancova 1 year before
sampsi 10.04 10.8, n1(107) n2(105) sd1(3.28) sd2(3.28) pre(1) post(1) r1(0.8)
local power = r(power)
putexcel C20 = 0.76, hcenter nformat(number_d2)
...
local power = r(power)
putexcel D18 = 1.83, hcenter nformat(number_d2)

	* after controlling for strata_final --> add
sampsi 3.07 4.5, n1(107) n2(105) sd1(3.70) sd2(3.70)
local power = r(power)
putexcel D19 = 1.43, hcenter nformat(number_d2)

	* Ancova 1 year before
sampsi 3.07 3.93, n1(107) n2(105) sd1(3.70) sd2(3.70) pre(1) post(1) r1(0.8)
local power = r(power)
putexcel D20 = 0.86, hcenter nformat(number_d2)
...
local power = r(power)
putexcel E18 = 0.24, hcenter nformat(number_d2)

	* after controlling for strata_final --> add
sampsi 0.18 0.36, n1(107) n2(105) sd1(0.45) sd2(0.45)
local power = r(power)
putexcel E19 = 0.18, hcenter nformat(number_d2)

	* Ancova 1 year before
sampsi 0.18 0.29, n1(107) n2(105) sd1(0.45) sd2(0.45) pre(1) post(1) r1(0.8)
local power = r(power)
putexcel E20 = 0.11, hcenter nformat(number_d2)
...
local power = r(power)
putexcel F18 = 0.19, hcenter nformat(number_d2)

	* after controlling for strata_final --> add
sampsi 0.4 0.56, n1(107) n2(105) sd1(0.41) sd2(0.41)
local power = r(power)
putexcel F19 = 0.16, hcenter nformat(number_d2)

	* Ancova 1 year before
sampsi 0.4 0.5, n1(107) n2(105) sd1(0.41) sd2(0.41) pre(1) post(1) r1(0.8)
local power = r(power)
putexcel F20 = 0.1, hcenter nformat(number_d2)
...
local power = r(power)
putexcel G18 = 0.27, hcenter nformat(number_d2)

	* after controlling for strata_final --> add
sampsi 0 0.2, n1(107) n2(105) sd1(0.52) sd2(0.52)
local power = r(power)
putexcel G19 = 0.2, hcenter nformat(number_d2)

	* Ancova 1 year before
sampsi 0 0.12, n1(107) n2(105) sd1(0.52) sd2(0.52) pre(1) post(1) r1(0.8)
local power = r(power)
putexcel G20 = 0.12, hcenter nformat(number_d2)
...
local power = r(power)
putexcel H18 = 2.66, hcenter nformat(number_d2)

	* after controlling for strata_final --> add
sampsi 10.54 12.9, n1(107) n2(105) sd1(6.14) sd2(6.14)
local power = r(power)
putexcel H19 = 2.36, hcenter nformat(number_d2)

	* Ancova 1 year before
sampsi 10.54 12, n1(107) n2(105) sd1(6.14) sd2(6.14) pre(1) post(1) r1(0.8)
local power = r(power)
putexcel H20 = 1.46, hcenter nformat(number_d2)
