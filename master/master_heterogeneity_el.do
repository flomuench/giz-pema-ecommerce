...
***********************************************************************
* Ensure the data is sorted by id_plateforme and surveyround
sort id_plateforme surveyround
 
* Create new variables to hold the constant values for each variable
bysort id_plateforme (surveyround): egen ihs_ca99_2020sr = max(ihs_ca99_2020)
...
local ys ///
	...
	export_1 exp_pays clients_b2c clients_b2b ihs_ca97_2024 ihs_dig_invest_99 ihs_dig_empl_99 profit_2023_pos profit_2024_pos dig_rev_extmargin dig_invest_extmargin ihs_fte_femmes_99 ihs_fte_young_99 w99_dig_empl  ///
	ihs_cost97_2023 ihs_cost97_2024 bpi_2020 dig_margins mark_online4 exp_dig dig_invest ihs_ca99_2020sr
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_sector1_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2023 by product/service} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
coefplot ///
	...
	keep(*treatment take_up) drop(_cons) xline(0) ///
		...
		eqrename(`outcome'_p1 = `"Product (ITT)"' `outcome'_p2 = `"Product (TOT)"' `outcome'_s1 = `"Service (ITT)"' `outcome'_s2 = `"Service (TOT)"') ///
		ytitle("", size(medium)) ///
		xtitle("Business Performance Index 2023") ///
		leg(off) xsize(4.5) /// xsize controls aspect ratio, makes graph wider & reduces its height
		note("Confidence interval at the 95th percentile.", span size(small)) /// 95th only holds for lare firms
		name(el_het_sector1_`outcome', replace)
gr export el_het_sector1_`outcome'.png, replace
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_sector1_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2024 by product/service} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
coefplot ///
	...
	keep(*treatment take_up) drop(_cons) xline(0) ///
		...
		eqrename(`outcome'_p1 = `"Product (ITT)"' `outcome'_p2 = `"Product (TOT)"' `outcome'_s1 = `"Service (ITT)"' `outcome'_s2 = `"Service (TOT)"') ///
		ytitle("", size(medium)) ///
		xtitle("Business Performance Index 2024") ///
		leg(off) xsize(4.5) /// xsize controls aspect ratio, makes graph wider & reduces its height
		note("Confidence interval at the 95th percentile.", span size(small)) /// 95th only holds for lare firms
		name(el_het_sector1_`outcome', replace)
gr export el_het_sector1_`outcome'.png, replace
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_sector1_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2023 by product/service} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_s1 `outcome'_s2 `outcome'_m1 `outcome'_m2 `outcome'_l1 `outcome'_l2  
esttab `regressions' using "rt_hetero_size_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2023 by size} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_s1 `outcome'_s2 `outcome'_m1 `outcome'_m2 `outcome'_l1 `outcome'_l2  
esttab `regressions' using "rt_hetero_size_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2024 by size} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_s1 `outcome'_s2 `outcome'_m1 `outcome'_m2 `outcome'_l1 `outcome'_l2  
esttab `regressions' using "rt_hetero_size_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2023 by size} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_s1 `outcome'_s2 `outcome'_m1 `outcome'_m2 `outcome'_l1 `outcome'_l2  
esttab `regressions' using "rt_hetero_size_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2024 by size} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_model_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2023 by entreprise model} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_model_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2024 by entreprise model} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_model_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2023 by entreprise model} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_model_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2024 by entreprise model} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
***********************************************************************
* 	PART 6: Per higher margin of online sales
***********************************************************************
{
{
local outcome "dtai"
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_margin_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2023 by digital margin} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_margin_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2024 by digital margin} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_margin_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2023 by digital margin} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_margin_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2024 by digital margin} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital technology index by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
				...
				nobaselevels ///
				label 		/// specifies EVs have label
				mgroups("No export via digital" "Export via digital", ///
				pattern(1 1 1)) ///
				collabels(none) ///	do not use statistics names below models
				drop(_cons *.strata ?.missing_bl_* *_y0) ///
				noobs
				...
				* Bottom panel: ITT
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
		esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", append ///
				fragment ///
				posthead("\hline \\ \multicolumn{7}{c}{\textbf{Panel B: Treatment Effect on the Treated (TOT)}} \\\\[-1ex]") ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				stats(control_mean control_sd N strata bl_control, fmt(%9.2fc %9.2fc %9.0g) labels("Control group mean" "Control group SD" "Observations" "Strata controls" "Y0 controls")) ///
...
coefplot ///
	...
	keep(*treatment take_up) drop(_cons) xline(0) ///
		...
		swapnames /// swaps coeff & equation names after collecting result
		levels(95) /// 95th percentile is null-effect, although tight
		eqrename(`outcome'_p1 = `"No export via digital (ITT)"' `outcome'_p2 = `"No export via digital (TOT)"' `outcome'_s1 = `"Export via digital (ITT)"' `outcome'_s2 = `"Export via digital (TOT)"') ///
		ytitle("", size(medium)) ///
		xtitle("Turnover 2020") ///
		leg(off) xsize(4.5) /// xsize controls aspect ratio, makes graph wider & reduces its height
		note("Confidence interval at the 95th percentile.", span size(small)) /// 95th only holds for lare firms
		name(el_het_digexp_`outcome', replace)
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital sales index by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital marketing index by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on export perception index by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital technology perception index by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on export readiness index by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
*special case bpi_2020 placebo effect
{
local outcome "bpi_2020"
local conditions "exp_dig==0 exp_dig==1"
local sectors "p s"
foreach cond of local conditions {
		gettoken sector sectors : sectors
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2020 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
coefplot ///
	...
	keep(*treatment take_up) drop(_cons) xline(0) ///
		...
		eqrename(`outcome'_p1 = `"No export via digital (ITT)"' `outcome'_p2 = `"No export via digital (TOT)"' `outcome'_s1 = `"Export via digital (ITT)"' `outcome'_s2 = `"Export via digital (TOT)"') ///
		ytitle("", size(medium)) ///
		xtitle("Business Performance Index 2020") ///
		leg(off) xsize(4.5) /// xsize controls aspect ratio, makes graph wider & reduces its height
		note("Confidence interval at the 95th percentile.", span size(small)) /// 95th only holds for lare firms
		name(el_het_digexp_`outcome', replace)
gr export el_het_digexp_`outcome'.png, replace
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2023 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2024 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital revenue by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on profit 2023 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on profit 2024 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2023 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on costs 2024 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on turnover 2023 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on turnover 2024 by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital investment by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_p1 `outcome'_p2 `outcome'_s1 `outcome'_s2
esttab `regressions' using "rt_hetero_digexp_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital employees by digital export} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
***********************************************************************
* 	PART 8: knowledge_index below vs. above median Heterogeneity
***********************************************************************
{
* Ensure the data is sorted by id_plateforme and surveyround
sort id_plateforme surveyround
...
* Create new variables to hold the constant values for each variable
bysort id_plateforme (surveyround): egen knowledge_index_constant = max(knowledge_index)

* Replace the original variables with the constant values across all surveyrounds
bysort id_plateforme: replace knowledge_index = knowledge_index_constant




* Drop the temporary constant variables if no longer needed
drop knowledge_index_constant

/*
sum knowledge_index if surveyround==3, d

         Z-score index for e-commerce/dig.marketing
                          knowledge
-------------------------------------------------------------
      Percentiles      Smallest
 1%    -1.636772      -1.937508
 5%     -.895947      -1.937508
10%     -.509891      -1.636772       Obs                 205
25%    -.2553501      -1.621129       Sum of wgt.         205

50%     .1473099                      Mean            .099106
                        Largest       Std. dev.      .5696197
75%     .4777971       1.203567
90%     .7611225       1.203567       Variance       .3244666
95%     .9760066       1.295581       Skewness      -.7594196
99%     1.203567       1.295581       Kurtosis       4.476672
...
{
local outcome "dig_margins"
local conditions "knowledge_index<=.1473099 knowledge_index>.1473099"
local groups "o b"
foreach cond of local conditions {
		gettoken group groups : groups
			eststo `outcome'_`group'1: reg `outcome' i.treatment c.`outcome'_y0 i.missing_bl_`outcome' i.strata if `cond' & surveyround==3, cluster(id_plateforme)
...
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital margins by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
coefplot ///
	...
	keep(*treatment take_up) drop(_cons) xline(0) ///
		...
		ytitle("", size(medium)) ///
		xtitle("Digital margin") ///
		leg(off) xsize(4.5) /// xsize controls aspect ratio, makes graph wider & reduces its height
		note("Confidence interval at the 95th percentile.", span size(small)) /// 95th only holds for lare firms
		name(el_het_KI_`outcome', replace)
gr export el_het_KI_`outcome'.png, replace
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital revenue from ecommerce by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
{
local outcome "dig_rev_extmargin"
local conditions "knowledge_index<=.1473099 knowledge_index>.1473099"
local groups "o b"
foreach cond of local conditions {
		gettoken group groups : groups
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital revenue extensive margin from ecommerce by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on paid social media marketing by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
coefplot ///
	...
	keep(*treatment take_up) drop(_cons) xline(0) ///
		...
		eqrename(`outcome'_o1 = `"Below Median (ITT)"' `outcome'_o2 = `"Below Median (TOT)"' `outcome'_b1 = `"Above Median (ITT)"' `outcome'_b2 = `"Above Median (TOT)"') ///
		ytitle("", size(medium)) ///
		xtitle("Paid social media marketing") ///
		leg(off) xsize(4.5) /// xsize controls aspect ratio, makes graph wider & reduces its height
		note("Confidence interval at the 95th percentile.", span size(small)) /// 95th only holds for lare firms
		name(el_het_KI_`outcome', replace)
gr export el_het_KI_`outcome'.png, replace
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2020 by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2023 by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on business performance index 2024 by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital export by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital marketing index by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital invest by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
{
local outcome "dig_invest_extmargin"
local conditions "knowledge_index<=.1473099 knowledge_index>.1473099"
local groups "o b"
foreach cond of local conditions {
		gettoken group groups : groups
...
estadd scalar control_sd = r(sd)
	...
	local regressions `outcome'_o1 `outcome'_o2 `outcome'_b1 `outcome'_b2 
esttab `regressions' using "rt_hetero_median_`outcome'.tex", replace ///
				prehead("\begin{table}[!h] \centering \\ \caption{Treatment effect on digital invest extensive margin by knowledge index} \\ \begin{adjustbox}{width=\columnwidth,center} \\ \begin{tabular}{l*{5}{c}} \hline\hline") ///
				posthead("\hline \\ \multicolumn{3}{c}{\textbf{Panel A: Intention-to-treat (ITT)}} \\\\[-1ex]") ///
				fragment ///
				cells(b(star fmt(3)) se(par fmt(3)) p(fmt(3)) rw) ///
				mlabels(, depvars) /// use dep vars labels as model title
...
coefplot ///
	...
	keep(*treatment take_up) drop(_cons) xline(0) ///
		...
		eqrename(`outcome'_o1 = `"Below Median (ITT)"' `outcome'_o2 = `"Below Median (TOT)"' `outcome'_b1 = `"Above Median (ITT)"' `outcome'_b2 = `"Above Median (TOT)"') ///
		ytitle("", size(medium)) ///
		xtitle("Digital invest > 0") ///
		leg(off) xsize(4.5) /// xsize controls aspect ratio, makes graph wider & reduces its height
		note("Confidence interval at the 95th percentile.", span size(small)) /// 95th only holds for lare firms
		name(ml_het_KI_`outcome', replace)
gr export ml_het_KI_`outcome'.png, replace
